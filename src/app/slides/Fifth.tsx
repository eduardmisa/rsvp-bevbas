...
export const Fifth = () => {
  ...
  return (
      <div className="flex items-center w-screen h-screen bg-[#FFFBF7]">
        <div className="flex flex-col absolute lg:relative h-full p-0 w-full lg:w-[70%] h-full">
          <Image
          ...
          />
          <h2 className="absolute text-5xl font-seasons p-10 lg:w-[75%] leading-tight">
            We hope to see you from the altar.
          </h2>
        </div>
        <div className="flex flex-col absolute lg:relative w-full lg:w-[30%] p-10 mt-96 lg:mt-0 h-full font-seasons">
