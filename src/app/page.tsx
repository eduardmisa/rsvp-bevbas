...
export default function Home() {
  return (
    <main className="flex flex-col min-h-screen min-w-screen flex-col justify-between">
      <div className="flex w-full pt-4 pb-1 bg-white font-julius block">
        <div className="flex w-fit gap-x-6 mx-auto">
          <div className="px-4">
            <span className="block text-[#2b5643] text-center font-bold decoration-1 underline underline-offset-4 mb-1">DATE & TIME</span>
            <span className="block text-[#90cbc9] text-center text-sm font-bold">September 30, 2023</span>
            <span className="block text-[#90cbc9] text-center text-sm font-bold">10:00 AM</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center w-screen h-screen bg-[url('/assets/eucalyptus.jpg')] bg-no-repeat bg-cover md:bg-contain bg-center ">
        <div className="m-auto">
          <h1 className="text-center m-auto font-arabella text-6xl text-gray-700 space-x-4">
      ...
      <div className="flex flex-col items-center w-screen bg-[url('/assets/plantsflowers-top.jpg')] bg-no-repeat bg-contain md:bg-contain">
        <div className="mt-10 w-auto w-[85vw] md:w-[50vw] border bg-white p-6">
      ...
      <div className="flex flex-col min-h-screen items-center w-screen bg-[url('/assets/vertical-leaves.jpg')] bg-no-repeat bg-cover md:bg-contain mt-32">
        <div className="my-auto mx-auto w-[90vw] md:w-[50vw] border">
          <Image
          ...
          <div className="bg-white px-4 py-10">
            <h2 className="text-center text-center font-julius text-xl md:text-4xl text-[#2b5643]">
              Your presence at our wedding is the only present we require.
            </h2>
            <br/>
            <h4 className="text-center text-center font-julius text-sm md:text-lg text-[#2b5643]">
      ...
      <div className="relative flex flex-col h-fit items-center w-screen mt-24 md:mt-40">
